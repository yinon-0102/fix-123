 ...
 */
export declare function getLabelPositionStyle(key: EdgeKey, placement: EdgeLabelStyleProps['placement'], autoRotate: boolean, offsetX: number, offsetY: number, isLoop?: boolean, loopPlacement?: LoopPlacement): Partial<EdgeLabelStyleProps>;
/**
 * <zh/> 获取边上徽标的位置样式
 *
 ...
 */
export declare function getArcLoopPath(node: Node, placement: LoopPlacement, clockwise: boolean, dist: number, sourcePortKey?: string, targetPortKey?: string): PathArray;
/**
 * <zh/> 获取环形边的控制点
 *
