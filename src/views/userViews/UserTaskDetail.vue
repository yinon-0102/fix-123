...
.t-head { background: #fff; border: 1px solid #CBDBF5; border-radius: 12px; padding: 18px 20px; box-shadow: 0 2px 12px rgba(51,65,85,.05); }
...
.t-imgs img { width: 84px; height: 84px; object-fit: cover; border-radius: 8px; border: 1px solid #CBDBF5; }
.state-box { display: flex; align-items: center; gap: 12px; background: #fff; border: 1px solid #CBDBF5; border-radius: 12px;
