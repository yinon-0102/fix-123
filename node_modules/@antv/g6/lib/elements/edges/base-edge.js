...
class BaseEdge extends base_element_1.BaseElement {
    ...
    getLoopPath(attributes) {
        ...
        const { type: loopType, placement, clockwise, dist = defaultDist, } = (0, prefix_1.subStyleProps)(this.getGraphicStyle(attributes), 'loop');
        return loopType === 'arc'
            ? (0, edge_1.getArcLoopPath)(node, placement, clockwise, dist, sourcePort, targetPort)
            : (0, edge_1.getCubicLoopPath)(node, placement, clockwise, dist, sourcePort, targetPort);
    }
    ...
    getLabelStyle(attributes) {
        ...
        const isLoop = attributes.loop && (0, element_1.isSameNode)(this.sourceNode, this.targetNode);
        // 获取自环边的配置 | Get loop edge config
        const { placement: loopPlacement } = (0, prefix_1.subStyleProps)(this.getGraphicStyle(attributes), 'loop');
        const labelPositionStyle = (0, edge_1.getLabelPositionStyle)(this.shapeMap.key, placement, autoRotate, offsetX, offsetY, isLoop, loopPlacement);
    ...
    getBadgeStyle(attributes) {
        if (attributes.badge === false || !attributes.badgeText)
            return false;
        const _a = (0, prefix_1.subStyleProps)(attributes, 'badge'), { offsetX, offsetY, placement } = _a, badgeStyle = __rest(_a, ["offsetX", "offsetY", "placement"]);
    ...
    getArrowStyle(attributes, isStart) {
        ...
        const _a = (0, prefix_1.subStyleProps)(this.getGraphicStyle(attributes), arrowType), { size, type } = _a, arrowStyle = __rest(_a, ["size", "type"]);
        ...
        return Object.assign((0, util_1.pick)(keyStyle, ['stroke', 'strokeOpacity', 'fillOpacity']), { width, height }, Object.assign({}, (d && { d, fill: type === 'simple' ? '' : keyStyle.stroke })), arrowStyle);
    }
