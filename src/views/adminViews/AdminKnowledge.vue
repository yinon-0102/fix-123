...
function getFileTypeColor(fileType) {
  ...
  if (type === 'docx' || type === 'doc') return { bg: '#EFF6FF', accent: '#3B82F6', label: 'WORD' }
  if (type === 'xlsx' || type === 'xls') return { bg: '#F0FDF4', accent: '#22c55e', label: 'EXCEL' }
  if (type === 'txt') return { bg: '#F8F8F8', accent: '#64748B', label: 'TXT' }
            ...
            <div class="book-cover">
              ...
              >
                ...
                <svg v-else-if="(item.fileType || 'doc').toLowerCase().replace(/^\./, '').includes('doc')" class="file-icon-svg" viewBox="0 0 48 64" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <rect x="14" y="40" width="18" height="3" rx="1.5" fill="#3B82F6" opacity="0.25"/>
                  <text x="12" y="22" font-family="sans-serif" font-size="7" fill="#3B82F6" font-weight="700">WORD</text>
                </svg>
                <svg v-else class="file-icon-svg" viewBox="0 0 48 64" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M8 4h24l12 12v44H8V4z" fill="#F8F8F8" stroke="#94A3B8" stroke-width="1.5"/>
                  <path d="M28 4v12h12" fill="#F1F5F9" stroke="#94A3B8" stroke-width="1.5"/>
                  <rect x="14" y="26" width="20" height="3" rx="1.5" fill="#94A3B8" opacity="0.6"/>
                  <rect x="14" y="33" width="16" height="3" rx="1.5" fill="#94A3B8" opacity="0.4"/>
                  <text x="16" y="22" font-family="sans-serif" font-size="8" fill="#64748B" font-weight="700">FILE</text>
                </svg>
              </div>
            </div>
