...
class ProcessParallelEdges extends base_transform_1.BaseTransform {
    constructor(context, options) {
        ...
        this.applyBundlingStyle = (input, edges, distance) => {
            ...
            const loopMode = (_a = this.options.loopMode) !== null && _a !== void 0 ? _a : 'spread';
            const loopDistance = (_b = this.options.loopDistance) !== null && _b !== void 0 ? _b : distance;
            ...
            edgeMap.forEach((arcEdges) => {
                arcEdges.forEach((edge, i, edgeArr) => {
                    ...
                    if (edge.source === edge.target) {
                        if (loopMode === 'nested') {
                            ...
                            if (style.loopDist === undefined) {
                                const count = (_a = placementCounts.get(key)) !== null && _a !== void 0 ? _a : 0;
                    ...
                    const element = (_b = this.context.element) === null || _b === void 0 ? void 0 : _b.getElement((0, id_1.idOf)(edge));
